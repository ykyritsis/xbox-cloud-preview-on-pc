# Community beta — 0.25.0-beta.1

Use `dist/Xbox-Preview-UI-Setup-0.25.0-beta.1.exe` to install, or `dist/Xbox-Preview-UI-Portable-0.25.0-beta.1.exe` without installation. Close the previous launcher first. Existing local settings are retained.
